...
counts3 %>% distinct(organism) %>% pull()
multiyear_spp %>% pull(organism)
...
# NOTE: now that we're using the highly sampled dataset, this step doesn't do anything
