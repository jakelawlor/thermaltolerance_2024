...
# NOTE: this threw warnings for 3 species with divergent transitions
...
cover_trends <- int_cover_coefs_plotdf %>%
  ...
  geom_text(data = int_cover_coefs_plotdf %>% 
...
ggview::ggview(cover_trends, width = 13.5, height = 12, unit = "in")
